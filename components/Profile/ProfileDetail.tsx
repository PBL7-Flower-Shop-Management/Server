...
const ProfileDetail = (props: any) => {
    ...
    const formik = useFormik({
        ...
        initialValues: profile
            ? {
                  ...
                  birthday:
                      profile.birthday &&
                      parse(profile.birthday, "dd/MM/yyyy", new Date()),
                  fatherBirthday:
                      profile.fatherBirthday &&
                      parse(profile.fatherBirthday, "dd/MM/yyyy", new Date()),
                  motherBirthday:
                      profile.motherBirthday &&
                      parse(profile.motherBirthday, "dd/MM/yyyy", new Date()),
              }
            : null,
    ...
    const handleClick = () => {
        ...
        // setOriginalProfile(formik.values);
        setIsFieldDisabled(false);
    };

    const handleCancel = () => {
        // dispatch({ type: "CANCEL_EDIT" });
        // formik.setValues(originalProfile);
